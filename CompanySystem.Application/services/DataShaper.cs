...
fieldsString)
        {
            ...
            return FetchData(entities, (IEnumerable<PropertyInfo>)requiredProperties);
        }
        ...
        private object GetRequiredProperties(string fieldsString)
        {
        ...
        {
            var requiredProperties = GetRequiredProperties(fieldsString);
            return FetchDataForEntity(entity, (IEnumerable<PropertyInfo>)requiredProperties);
        }
